...
UI Agent 执行界面设计、视觉规范与交互设计任务时，可以使用以下 skill：

## frontend-design

- 位置：`/Users/zrh/.codex/skills/frontend-design/SKILL.md`
- 用途：提供差异化、有意图的视觉设计指导，帮助建立有辨识度的界面方向，避免模板化设计。
- 适用场景：新界面设计、现有界面重塑、视觉方向与排版选型、界面文案写作。
- 使用方式：开始设计前加载该 skill，遵循其设计原则与工作流程（先出设计方案，再实现与自我审视）。
